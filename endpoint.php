...
switch($likes->method)
{
	case "like":$likes->like();
				...
				$likeText= $settings->text[2];
				elseif($likes->total_count==2)
					//$this->text_default[1]="You and 1 person like this post.";	
					$likeText=str_replace("1","<b>1</b>",$settings->text[1]);
				else 
					{ $likes->total_count--;
					//$this->text_default[0]="You and %NUM% people like this post.";
					$likeText=str_replace("%NUM%","<b>$likes->total_count</b>",$settings->text[0]);}
	...
	case "unlike":$likes->unlike();
				...
				$likeText=str_replace("%NUM%","<b>$likes->total_count</b>",$settings->text[3]);
				 
				}
				elseif($likes->total_count==1) {
					//$this->text_default[4]="1 person likes this post.";
					$likeText=str_replace("1","<b>1</b>",$settings->text[4]);
				}	
	break;
